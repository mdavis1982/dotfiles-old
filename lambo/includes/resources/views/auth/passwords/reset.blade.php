        ...
        <div class="mt-4 px-4 py-4 w-5/6 lg:w-1/4 bg-white border-t-8 border-teal-500 rounded-lg shadow-lg">
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <input id="email" type="email" class="mt-2 border rounded-lg px-2 py-2 bg-gray-100 focus:outline-none focus:border-teal-500 @error('email') border-red-200 bg-red-100 @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
